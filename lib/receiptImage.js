...
function loadFonts() {
  ...
  // Fonts are in lib/fonts/ (committed to git) so they're always available at runtime,
  // unlike node_modules which may not be bundled in Vercel serverless functions.
  const base = join(process.cwd(), "lib", "fonts");
...
const PROVIDER_LABEL = {
  ruangotp_s1: "QRIS RuangOTP S1",
  ruangotp_s2: "QRIS RuangOTP S2",
