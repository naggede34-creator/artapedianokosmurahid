...
import { otpOrdersCol, depositsCol, broadcastsCol, smmOrdersCol, userNotificationsCol, scratchCardsCol } from "@/lib/db";
...
export async function runCleanup() {
  ...
  // 6. AUTO-CLEAN: notifikasi yang sudah dibaca > 30 hari
  try {
  ...
  // 7. AUTO-CLEAN: scratch card yang sudah digunakan > 14 hari
  try {
