...
import { sendTelegramNotif, sendTelegramChannelNotif, leaderboardWinnersNotif } from "@/lib/telegram";
...
export async function settleWeek({ offset = -1, alasan = "cron", paksa = false } = {}) {
  ...
  if (winners.length) {
    ...
    sendTelegramChannelNotif(teks, { pin: true });
  }
