...
const DEFAULTS = {
  ...
  depositProviders: { ruangotp_s1: true, ruangotp_s2: true, pakasir: true, rumahotp: false },
  ...
  // Server OTP yang aktif. markupPercent null = ikut markupPercent global.
  otpServers: [
    { id: "rumahotp", name: "RumahOTP", enabled: true, markupPercent: null },
    { id: "ruangotp_s1", name: "Server Plus", enabled: true, markupPercent: null },
    { id: "ruangotp_s2", name: "Server Express", enabled: true, markupPercent: null },
    { id: "dibanana", name: "OTP Fast Murah", enabled: true, markupPercent: null }
  ],
