...
const DEFAULTS = {
  ...
  // Komik pembuka yang muncul sesudah loader di kunjungan pertama.
  // Dimatikan = pengunjung langsung sampai ke beranda.
  comicIntroEnabled: true,
...
function mergeSettings(doc) {
  ...
  return {
    ...
    comicIntroEnabled: doc.comicIntroEnabled ?? DEFAULTS.comicIntroEnabled,
...
export async function updateSettings(patch) {
  ...
  if (patch.comicIntroEnabled !== undefined) allowed.comicIntroEnabled = Boolean(patch.comicIntroEnabled);
