export default function SignalCard() {
  return (
    <div className="float-slow relative mx-auto w-full max-w-sm">
      ...
      <div className="hover-lift card-shadow rounded-3xl border border-line bg-surface p-6">
        <div className="flex items-center justify-between">
          <span className="text-xs text-muted">Nomor OTP aktif</span>
          <span className="flex items-center gap-1.5 text-xs font-medium text-teal-bright">
        ...
        <div className="code-reveal mt-4 rounded-xl border border-teal/30 bg-teal-soft p-4">
          <p className="text-xs font-medium text-teal-bright">Kode masuk</p>
